...
namespace FeatureToggle.Tests
{
    public class EnabledBetweenDatesFeatureToggleShould
    {
        ...
        public void DisableFeatureAfterToggleTimePeriod()
        {
            ...
            var expectedTimePeriod = new Tuple<DateTime, DateTime>(expectedNow.AddMilliseconds(-2), expectedNow.AddMilliseconds(-1));
        ...
        {
            var expectedNow = DateTime.Now;
            var expectedTimePeriod = new Tuple<DateTime, DateTime>(expectedNow.AddMilliseconds(1), expectedNow.AddMilliseconds(2));
        ...
        {
            var expectedNow = DateTime.Now;
            var expectedTimePeriod = new Tuple<DateTime, DateTime>(expectedNow.AddMilliseconds(-1), expectedNow.AddMilliseconds(1));
        ...
        {
            var expectedNow = DateTime.Now;
            var expectedTimePeriod = new Tuple<DateTime, DateTime>(expectedNow.AddMilliseconds(-1), expectedNow);
        ...
        {
            var expectedNow = DateTime.Now;
            var expectedTimePeriod = new Tuple<DateTime, DateTime>(expectedNow, expectedNow.AddMilliseconds(1));
